...
![Переход в каталог /tmp](image/12.png){#fig:001 width=70%}

## 2.2
   Выведем на экран содержимое каталога /tmp с помощью команды ls

![ls](image/13.png){#fig:001 width=50%}
...
![Создание каталога newdir](image/18.png){#fig:001 width=70%}

## 3.2
  В каталоге ~/newdir создаём новый каталог с именем morefun.

![Создание каталога morefun](image/19.png){#fig:001 width=70%}
...
![Создание каталогов и их удаление](image/21.png){#fig:001 width=70%}
    
## 3.4
 Удалим каталог ~/newdir/morefun из домашнего каталога. Проверьте, был ли
каталог удалён.

![Удаление каталога newdir](image/22.png){#fig:001 width=70%}
...
![Команда man ls](image/23.png){#fig:001 width=70%}

##

![Команда man ls](image/24.png){#fig:001 width=40%}

##

![ -R, --recursive](image/25.png){#fig:001 width=40%}
...
## --time-style
![--time-style=TIME_STYLE](image/26.png){#fig:001 width=40%}
...
![Команда man cd](image/27.png){#fig:001 width=40%}

## pwd

![Команда man pwd](image/28.png){#fig:001 width=40%}

## mkdir

![Команда man mkdir](image/29.png){#fig:001 width=40%}

## rmdir 

![Команда man rmdir](image/31.png){#fig:001 width=45%}

## rm

![Команда man rm](image/32.png){#fig:001 width=40%}
...
![Команда history](image/33.png){#fig:001 width=30%}

![Команда history](image/34.png){#fig:001 width=30%}

## 
 Выполним модификацию и исполнение нескольких команд из буфера команд
    
![Модификация команды №493](image/35.png){#fig:001 width=65%}

![Модификация команды №494](image/35.png){#fig:001 width=62%}
