...
![Имя домашнего каталога](image/11.png){#fig:001 width=70%}

2. Выполним следующие действия:
    2.1 Перейдём в каталог /tmp

![Переход в каталог /tmp](image/12.png){#fig:002 width=70%}

    2.2 Выведем на экран содержимое каталога /tmp с помощью команды ls

![ls](image/13.png){#fig:003 width=70%}
    
    Сравним команды ls -a и ls -F

![ls -a](image/14.png){#fig:004 width=70%}

![ls -F](image/15.png){#fig:005 width=70%}
...
![Создание каталогов и их удаление](image/21.png){#fig:010 width=70%}
    
    3.4 Удалите каталог ~/newdir/morefun из домашнего каталога. Проверьте, был ли
каталог удалён.

![Удаление каталога newdir](image/22.png){#fig:011 width=70%}
...
![Команда man ls](image/23.png){#fig:012 width=70%}

![Команда man ls](image/24.png){#fig:013 width=70%}

![ -R, --recursive](image/25.png){#fig:014 width=70%}
...
![--time-style=TIME_STYLE](image/26.png){#fig:015 width=70%}

6. Используйте команду man для просмотра описания следующих команд: cd, pwd, mkdir,
rmdir, rm. Поясните основные опции этих команд.

![Команда man cd](image/27.png){#fig:016 width=70%}

![Команда man pws](image/28.png){#fig:017 width=70%}

![Команда man mkdir](image/29.png){#fig:018 width=70%}

![Команда man rmdir](image/31.png){#fig:019 width=70%}

![Команда man rm](image/32.png){#fig:020 width=70%}

7.Получим при помощи команды history

![Команда history](image/33.png){#fig:021 width=70%}

![Команда history](image/34.png){#fig:022 width=70%}

    Выполним модификацию и исполнение нескольких команд из буфера команд
    
![Модификация команды №493](image/35.png){#fig:023 width=70%}

![Модификация команды №494](image/35.png){#fig:024 width=70%}

![Модификация команды №494](image/35.png){#fig:025 width=70%}
